          ...
          >
            ...
            <div className="relative mt-8 h-8 flex justify-center w-40 mx-auto">
              ...
              <motion.div
                ...
                animate={
                  isInView ? { opacity: [1, 1, 0, 0, 0, 0] } : { opacity: 0 }
                }
                transition={{
                  duration: 6,
                  times: [0, 0.15, 0.18, 0.8, 0.9, 1],
                  fill: "forwards",
                }}
              >
                ITEM LISTED
              ...
              <motion.div
                ...
                animate={
                  isInView ? { opacity: [0, 0, 1, 1, 0, 0] } : { opacity: 0 }
                }
                transition={{
                  duration: 6,
                  times: [0, 0.45, 0.48, 0.55, 0.58, 1], // Delay start until 0.45 (after stop at 0.45)
                  fill: "forwards",
                }}
              >
                ITEM IN TRANSIT
              ...
              <motion.div
                ...
                animate={
                  isInView ? { opacity: [0, 0, 0, 0, 1, 1] } : { opacity: 0 }
                }
                transition={{
                  duration: 6,
                  times: [0, 0.2, 0.4, 0.85, 0.88, 1], // Delay start until 0.85 (after stop at 0.85)
                  fill: "forwards",
                }}
              >
                ITEM SOLD
