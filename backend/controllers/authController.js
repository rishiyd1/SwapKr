...
exports.sendVerificationOTP = async (req, res) => {
    ...
    // Format 1: firstnamelastnamefirstletter.branch.year@nitj.ac.in (e.g., johnD.cs.23@nitj.ac.in)
    // Format 2: firstname.branch.year@nitj.ac.in (e.g., john.cs.23@nitj.ac.in)
